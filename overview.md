...
### NMEA0183
Based on the RS-422 serial interface, is now over 35 years old but has aged remarkably well and is still in use on many
...
most new boats have an NMEA2000 network. It can handle a wide spread of information sources from engines to stereos and
is faster that NMEA 0183 but more difficult to interface to.
...
channel](http://slack-invite.SignalK.org/). Suggestions and requests via [Github](http://github.com/SignalK) are
also welcome.
